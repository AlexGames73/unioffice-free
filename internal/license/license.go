package license;
import (_b "bytes"; _cb "compress/gzip"; _g "crypto"; _fe "crypto/aes"; _agf "crypto/cipher"; _ef "crypto/rand"; _df "crypto/rsa"; _ge "crypto/sha256"; _abb "crypto/sha512"; _fed "crypto/x509"; _bd "encoding/base64"; _db "encoding/binary"; _agc "encoding/hex"; _dg "encoding/json"; _ca "encoding/pem"; _gb "errors"; _ag "fmt"; _ce "github.com/AlexGames73/unioffice-free/common"; _eb "github.com/AlexGames73/unioffice-free/common/logger"; _d "io"; _fa "io/ioutil"; _cbc "log"; _ee "net"; _cc "net/http"; _cd "os"; _ed "path/filepath"; _a "regexp"; _f "sort"; _ab "strings"; _e "sync"; _gg "time";);
...
func _cge(_agb, _eda[] byte)([] byte, error) {
    ...
    if _, _aeb: = _d.ReadFull(_ef.Reader, _bdb);
    _aeb != nil {
        return nil, _aeb;
    };
...
const (_ff = "\u002d\u002d\u002d--\u0042\u0045\u0047\u0049\u004e\u0020\u0055\u004e\u0049D\u004fC\u0020L\u0049C\u0045\u004e\u0053\u0045\u0020\u004b\u0045\u0059\u002d\u002d\u002d\u002d\u002d"; _gga = "\u002d\u002d\u002d\u002d\u002d\u0045\u004e\u0044\u0020\u0055\u004e\u0049\u0044\u004f\u0043 \u004cI\u0043\u0045\u004e\u0053\u0045\u0020\u004b\u0045\u0059\u002d\u002d\u002d\u002d\u002d";);
...
func SetLegacyLicenseKey(s string) error {
    _gff: = _a.MustCompile("\u005c\u0073");s = _gff.ReplaceAllString(s, "");
    var _daa _d.Reader;_daa = _ab.NewReader(s);_daa = _bd.NewDecoder(_bd.RawURLEncoding, _daa);_daa,
    _ebe: = _cb.NewReader(_daa);
    if _ebe != nil {
        return _ebe;
    };_fee: = _dg.NewDecoder(_daa);_faga: = & LegacyLicense {};
    ...
    };_gee: = _gg.Now().UTC();_abeg: = LicenseKey {};_abeg.CreatedAt = _gee;_abeg.CustomerId = "\u004c\u0065\u0067\u0061\u0063\u0079";_abeg.CustomerName = _faga.Name;_abeg.Tier = LicenseTierBusiness;_abeg.ExpiresAt = _faga.Expiration;_abeg.CreatorName = "\u0055\u006e\u0069\u0044\u006f\u0063\u0020\u0073\u0075p\u0070\u006f\u0072\u0074";_abeg.CreatorEmail = "\u0073\u0075\u0070\u0070\u006f\u0072\u0074\u0040\u0075\u006e\u0069\u0064o\u0063\u002e\u0069\u006f";_abeg.UniOffice = true;_bgab = & _abeg;
    return nil;
};
...
func _eae(_cba, _dba[] byte)([] byte, error) {
    _bcd: = make([] byte, _bd.URLEncoding.DecodedLen(len(_dba)));_aaf,
    ...
    };_dfb: = _bcd[: _fe.BlockSize];_bcd = _bcd[_fe.BlockSize: ];_bag: = _agf.NewCFBDecrypter(_ece, _dfb);_bag.XORKeyStream(_bcd, _bcd);
    return _bcd,
    nil;
};
var _gde = & _e.Mutex {};
...
func _fec(_eeed[] byte)(_d.Reader, error) {
    _caa: = new(_b.Buffer);_eefdc: = _cb.NewWriter(_caa);_eefdc.Write(_eeed);_dafa: = _eefdc.Close();
    if _dafa != nil {
        return nil, _dafa;
    };
    return _caa,
...
func(_fg LegacyLicense) Verify(pubKey * _df.PublicKey) error {
    _fb: = _fg;_fb.Signature = "";_eea: = _b.Buffer {};_bed: = _dg.NewEncoder( & _eea);
    ...
    if _cfg != nil {
        return _cfg;
    };_ceb: = _ge.Sum256(_eea.Bytes());_cfg = _df.VerifyPKCS1v15(pubKey, _g.SHA256, _ceb[: ], _eee);
    return _cfg;
};
func _dedb(_gf string)(LicenseKey, error) {
    ...
    if _eg.ExpiresAtInt > 0 {
        _edb: = _gg.Unix(_eg.ExpiresAtInt, 0);_eg.ExpiresAt = _edb;
    };
    return _eg, nil;
};
...
func _efe(_gbe string, _fc string)([] byte, error) {
    var (_fcc int; _dff string;);
    for _, _dff = range[] string {
        "\u000a\u002b\u000a", "\u000d\u000a\u002b\r\u000a", "\u0020\u002b\u0020"
    } {
        if _fcc = _ab.Index(_fc, _dff);
        _fcc != -1 {
            break;
        };
    };
...
func init() {
    _acgg: = _cd.Getenv(_bbae);_caba: = _cd.Getenv(_bdd);
...
func MakeUnlicensedKey() * LicenseKey {
    _bea: = LicenseKey {};_bea.CustomerName = "\u0055\u006e\u006c\u0069\u0063\u0065\u006e\u0073\u0065\u0064";_bea.Tier = LicenseTierUnlicensed;_bea.CreatedAt = _gg.Now().UTC();_bea.CreatedAtInt = _bea.CreatedAt.Unix();
    return &_bea;
};
...
func(_acb defaultStateHolder) loadState(_bdg string)(reportState, error) {
    ...
    };_bcg: = _ed.Join(_cdf, "\u002eu\u006e\u0069\u0064\u006f\u0063");_fde: = _cd.MkdirAll(_bcg, 0777);
    if _fde != nil {
        return reportState {}, _fde;
    };
    if len(_bdg) < 20 {
        return reportState {}, _gb.New("i\u006e\u0076\u0061\u006c\u0069\u0064\u0020\u006b\u0065\u0079");
    };_bec: = [] byte(_bdg);_bga: = _abb.Sum512_256(_bec[: 20]);_ggb: = _agc.EncodeToString(_bga[: ]);_afc: = _ed.Join(_bcg, _ggb);_fce,
    ...
    const _ccfc = "\u0068\u00619\u004e\u004b\u0038]\u0052\u0062\u004c\u002a\u006d\u0034\u004c\u004b\u0057";_fce,
    _fde = _eae([] byte(_ccfc), _fce);
    if _fde != nil {
        return reportState {}, _fde;
    };
    var _cfb reportState;_fde = _dg.Unmarshal(_fce, & _cfb);
    if _fde != nil {
...
func(_agfa defaultStateHolder) updateState(_ga, _acg, _bc string, _bbg int, _fgd bool, _aefa int, _bba int, _feaa _gg.Time, _bda map[string] int) error {
    ...
    };_cbef: = _ed.Join(_bfga, "\u002eu\u006e\u0069\u0064\u006f\u0063");_adb: = _cd.MkdirAll(_cbef, 0777);
    if _adb != nil {
        return _adb;
    };
    if len(_ga) < 20 {
        return _gb.New("i\u006e\u0076\u0061\u006c\u0069\u0064\u0020\u006b\u0065\u0079");
    };_fbge: = [] byte(_ga);_fgc: = _abb.Sum512_256(_fbge[: 20]);_fef: = _agc.EncodeToString(_fgc[: ]);_bfa: = _ed.Join(_cbef, _fef);
    var _ceg reportState;_ceg.Docs = int64(_bbg);_ceg.NumErrors = int64(_bba);_ceg.LimitDocs = _fgd;_ceg.RemainingDocs = int64(_aefa);_ceg.LastWritten = _gg.Now().UTC();_ceg.LastReported = _feaa;_ceg.Instance = _acg;_ceg.Next = _bc;_ceg.Usage = _bda;_gdc,
    _adb: = _dg.Marshal(_ceg);
    if _adb != nil {
        return _adb;
    };
    const _abf = "\u0068\u00619\u004e\u004b\u0038]\u0052\u0062\u004c\u002a\u006d\u0034\u004c\u004b\u0057";_gdc,
